...
export default function KontakPage() {
  ...
  const departmentContacts = [
    {
      department: "Kepala Madrasah",
      name: "Dra. Hj. Mahmudah",
      phone: "(0264) 315556",
      email: "kepala@mts-alfalah.sch.id",
      icon: Building,
      color: "text-blue-600",
    },
    {
      department: "Komite Madrasah",
      name: "Arif Rahman, S.Pd.I",
      phone: "(0264) 315556",
      email: "komite@mts-alfalah.sch.id",
      icon: Users,
    ...
    },
    {
      ...
      phone: "(0264) 315556",
      email: "kurikulum@mts-alfalah.sch.id",
      icon: BookOpen,
      color: "text-red-600",
    },
  ]
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
              Kami siap membantu Anda dengan informasi lengkap tentang MTs Al-Falah Karawang
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-white text-blue-600 hover:bg-blue-50">
                <a href="https://wa.me/6264315556" target="_blank" rel="noopener noreferrer">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">Alamat Madrasah</h3>
                        <p className="text-gray-600">
                          Jl. Mashudi No.2 RT.03/03
                          <br />
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 mb-1">(0264) 315556</p>
                        <p className="text-gray-600">NPSN: 20279226</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 mb-1">info@mts-alfalah.sch.id</p>
                        <p className="text-gray-600">admin@mts-alfalah.sch.id</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 mb-1">www.mts-alfalah.sch.id</p>
                        <p className="text-gray-600">NPWP: 00.505.352.5-433.000</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      ...
                      <Button asChild variant="outline" size="lg" className="w-full bg-transparent">
                        <a href="mailto:info@mts-alfalah.sch.id">
          ...
          {/* Map Section */}
          <div className="mt-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Lokasi Madrasah</h2>
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <ul className="text-gray-600 space-y-1 text-sm">
                          <li>• Masjid Al Falah (100m)</li>
                          <li>• Kantor Desa Pangulah Utara (500m)</li>
                          <li>• Pasar Pangulah (800m)</li>
                        </ul>
                      </div>
                      <div>
