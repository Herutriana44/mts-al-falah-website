...
export default function KepalaSekolahPage() {
  // Dummy data for profilMadrasah, replace with actual import or fetch if available
  const profilMadrasah = {
    nama_kepala: "Drs. H. Ahmad Fauzi",
    no_telp: "0812-3456-7890",
    alamat: "Jl. Raya Kotabaru No. 123, Karawang",
    email: "ahmad.fauzi@mts-alfalah.sch.id",
    office: "Kantor MTS Al Falah",
    tempat_lahir: "Karawang",
    tanggal_lahir: "1 Januari 1970",
    agama: "Islam",
    status: "Menikah",
  }

  const principalData = {
    name: profilMadrasah.nama_kepala,
    position: "Kepala Madrasah MTS Al Falah Kotabaru Karawang",
    photo: "/placeholder-user.jpg", // Ganti dengan foto asli jika tersedia
    contact: {
      phone: profilMadrasah.no_telp,
      email: profilMadrasah.email,
      office: profilMadrasah.office,
    },
    personal: {
      birthPlace: profilMadrasah.tempat_lahir,
      birthDate: profilMadrasah.tanggal_lahir,
      address: profilMadrasah.alamat,
      religion: profilMadrasah.agama,
      maritalStatus: profilMadrasah.status,
    },
    education: [
      {
      ...
      {
        degree: "S2 Manajemen Pendidikan Islam",
        institution: "UIN Sunan Gunung Djati Bandung",
        year: "2005 - 2007",
        achievement: "Lulus dengan predikat cum laude",
      },
    ],
    experience: [
      {
        ...
        period: "1990 - 2000",
        description: "Mengajar mata pelajaran PAI dan aktif dalam pengembangan kurikulum keagamaan.",
      },
      {
        position: "Wakil Kepala Madrasah MTs Al-Falah",
        period: "2000 - 2010",
        description: "Membantu kepala madrasah dalam pengelolaan akademik dan pengembangan tenaga pendidik.",
      },
      {
        position: "Kepala Madrasah MTs Al-Falah",
        period: "2010 - Sekarang",
        description: "Memimpin madrasah dalam mewujudkan visi peserta didik yang unggul dalam IPTEK berlandaskan IMTAQ.",
      },
    ],
    achievements: [
