...
export default function StrukturOrganisasiPage() {
  ...
  const organizationStructure = {
    ...
    komite: {
      name: madrasahData.komite_madrasah,
    ...
    guru: {
      ...
      list: madrasahData.list_nama_guru,
      total: madrasahData.list_nama_guru.length,
    },
    staff: [
