...
export default function VisiMisiPage() {
  const visionStatement =
    "Menjadi madrasah tsanawiyah yang unggul dalam prestasi, berakhlak mulia, dan berwawasan global berdasarkan nilai-nilai Islam yang rahmatan lil alamiin."
  ...
  const missions = [
    {
      ...
      description:
        "Menyelenggarakan pendidikan Islam yang berkualitas tinggi dengan memadukan kurikulum nasional dan kurikulum khas madrasah secara seimbang dan komprehensif.",
    ...
    },
    {
      ...
      description:
        "Mengembangkan potensi siswa secara optimal dalam bidang akademik, non-akademik, dan spiritual melalui pembelajaran yang inovatif dan bermakna.",
    ...
    },
    {
      ...
      description:
        "Membentuk generasi yang berakhlak mulia, bertakwa kepada Allah SWT, dan memiliki kepribadian yang kuat berdasarkan nilai-nilai Islam.",
    ...
    },
    {
      ...
      description:
        "Mempersiapkan siswa yang memiliki wawasan global, mampu bersaing di era digital, dan siap menghadapi tantangan masa depan dengan tetap berpegang teguh pada nilai-nilai Islam.",
    ...
    },
    {
      ...
      description:
        "Menciptakan lingkungan belajar yang kondusif dan Islami untuk meraih prestasi terbaik dalam berbagai bidang kompetisi akademik dan non-akademik.",
    ...
    },
    {
      ...
      description:
        "Menciptakan lingkungan sekolah yang Islami, aman, nyaman, dan kondusif untuk pembelajaran serta pengembangan diri siswa secara holistik.",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Landasan filosofis dan arah pengembangan MTS Al Falah Kotabaru Karawang menuju keunggulan pendidikan Islam
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Enam misi utama yang menjadi panduan dalam setiap program dan kegiatan sekolah
            </p>
          </div>
              ...
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 group">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <Badge className={mission.color}>{`Misi ${index + 1}`}</Badge>
                  </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center space-x-4">
              ...
              <div className="text-left">
                <div className="font-bold">Drs. H. Ahmad Fauzi, M.Pd.I</div>
